...
# Task
현재 시점({current_date})을 기준으로, 30-40대 직장인을 위한 **다양한** AI/Tech 주제를 선정하여 출력하십시오.
...
2. 다음 주제는 절대 선정하지 마십시오:
   ...
   - "AI 비서", "AI 에이전트", "업무 효율" 등 **이미 많이 다룬 주제**

# 🌟 다양한 주제 카테고리 (우선순위 높음)
최신 AI/Tech 트렌드를 반영한 **새롭고 신선한** 주제를 선정하세요:

**A. 최신 AI 모델/서비스 활용**
- Gemini 2.0 Flash Thinking 모드 실전 활용법
- GenSpark AI Search로 정보 검색 10배 빠르게
- Nano Banana (Gemini 2.5 Flash Image) 이미지 생성 비법
- Antigravity (프로젝트 관리) vs Notion AI 비교
- DeepSeek V3 무료 코딩 어시스턴트 활용법

**B. 구체적인 업무 시나리오**
- Excel 반복 작업, AI로 자동화 (VBA 대체)
- 고객 이메일 답변, AI로 3배 빠르게
- 회의록 자동 생성 (Otter.ai, Clova Note)
- PPT 디자인, Canva AI로 전문가처럼

**C. 학습/자기계발**
- Duolingo AI로 영어 회화 20분/일 실전 학습
- YouTube AI 요약으로 학습 시간 50% 단축
- Notion AI로 독서 노트 자동 정리
- ChatGPT로 영어 이메일 첨삭 받기

**D. 라이프스타일/취미**
- AI로 여행 일정 자동 짜기 (Google Gemini)
- Midjourney로 개인 브랜딩 이미지 제작
- AI 음악 생성 (Suno, Udio) 취미 시작하기
- 헬스/요가 동작, AI 폼 분석 (Tempo, Mirror)

# Selection Criteria (선정 기준)
1. 대상: 비개발자 직장인, 프리랜서
2. 효용: 업무 효율화, 시간 단축, 자동화 등 즉각적인 이득
3. 트렌드: 2025년 최신 AI 서비스 및 기능 우선 반영
4. **다양성**: 기존 글과 명확히 차별화된 새로운 각도

# Output Format
- 부연 설명 없이 완성된 제목 1줄만 출력하십시오.
- 형식: [타겟] + [구체적 도구/서비스명] + [구체적 결과/숫자]
- 예시: "직장인, Gemini 2.0 Thinking으로 보고서 작성 시간 40% 단축"
"""
